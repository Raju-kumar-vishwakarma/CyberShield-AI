  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-mono uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        cyber: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)] hover:scale-[1.02]",
        danger: "bg-destructive/20 text-destructive border border-destructive/50 hover:bg-destructive/30 hover:shadow-[0_0_20px_hsl(var(--destructive)/0.4)]",
        success: "bg-success/20 text-success border border-success/50 hover:bg-success/30 hover:shadow-[0_0_20px_hsl(var(--success)/0.4)]",
      },
      size: {
