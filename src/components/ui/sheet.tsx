...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/90 backdrop-blur-2xl p-6 shadow-[0_0_48px_rgba(0,0,0,0.5)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
